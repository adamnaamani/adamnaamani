...
While comical and entertaining in nature, Sim City can be representative of the dire consequences of improper city planning, as we take a glimpse into how the Lower Mainland's public transportation, existing and proposed, ultimately affects property values and the utility of those who decide to call this place home.
...
What we are seeing in the Lower Mainland is the increase of 'edge cities', where large clusters of commercial and high-density residential developments are emerging outside of the downtown core (e.g. Burnaby, Coquitlam, and Richmond). Jones Lang Lasalle periodically releases [studies](http://www.joneslanglasalle.ca/ResearchLevel1/RTI-Report-Q3-2013.pdf) of transit oriented leasing activity, monitoring the effects that transit lines such as SkyTrain have on vacancy and property value. They measure activity using the following metrics:
...
- Rapid transit for communities of Burnaby, Coquitlam, and Port Moody.
- Provides connectivity to the wider transit network.
- Stations: 7
- Travel time: 15 minutes from Lougheed Town Centre to Coquitlam.
- Completed summer 2016.
- Cost to complete is $1.4 billion.

**Surrey Rapid Transit**

- **Alternative 1:** Bus rapid transit on Fraser Highway, King George Boulevard, and 104th Avenue.
- **Alternative 2:** Light rail on Fraser Highway, and bus transit on King George Boulevard and 104th Avenue.
- **Alternative 3:** Light rail on Fraser Highway, 104th Avenue, and King George Boulevard south to Newton, with bus rapid transit from Newton to White Rock.
- **Alternative 4:** Skytrain on Fraser Highway, and bus rapid transit on King George Boulevard and 104th Avenue.
- Options ranging in costs between $0.9 billion to $2.2 billion.
...
- **Alternative 1:** Street level or partially tunnelled light rail.
- **Alternative 2:** A combination of street-level light rail and tunnelled SkyTrain.
- **Alternative 3:** A tunnelled SkyTrain.
- Rapid transit options for the Broadway corridor, from Commercial-Broadway Station to UBC, one of the region's busiest corridors.
- Options ranging in costs between $1.1 billion to $3 billion.
