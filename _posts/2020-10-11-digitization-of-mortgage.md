---
layout: post
title: Digitization of Mortgage
date: '2020-10-11 22:55:02 -0700'
slug: digitization-of-mortgage
description: Mortgage Data Standards–analyzing the impact of initiating a system of data standards in the Canadian mortgage industry.
...
CMHC released a publication on [Mortgage Data Standards](https://assets.cmhc-schl.gc.ca/sites/cmhc/data-research/publications-reports/mortgage-industry-data-standards/mortgage-industry-data-standards-en.pdf?rev=8a9135c0-42ac-4a96-ac3e-073d1db98617)–analyzing the impact of initiating a system of data standards in the Canadian mortgage industry. One aspect of the data standards framework I'm paying close attention to is what the acceleration of digitization means to the future of mortages. The overarching premise is to provide the foundation for innovation development, and facilitate easier technology adoption.

The recent launch of [Placekey](https://www.placekey.io/)–an intiative surrounding a universal place identifier that unifies location data–already demonstrates the collective shift toward an open ecosystem of data elements, definitions, and relationships that make up a reference model. It's a movement of organizations and individuals that prize access to [geospatial data](https://adamnaamani.com/shaping-the-future-of-proptech-with-gis/).

[Cherre](https://cherre.com/) is another interesting startup to watch in this space, part of an already impressive list of Placekey's launch partners. They deploy a similar form of data unification, in their case with a patented [Entity Resolution Computing System](https://www.freepatentsonline.com/20190236082.pdf) that connects disparate entities, of which in real estate there are many.

> "_Many industries rely on publicly sourced network-accessible data, the quality and accuracy of which is not always easily ascertained. Resolving entities based on such data can be computationally intensive based on the volume and quality of the data. The real estate industry in particular is faced with data from various disparate municipalities which is maintained at different levels of government, including for example borough, city, county, and state governments._" – _Cherre, Inc._
...
> "_Reductions in information asymmetry in the securitization market attract more investors and lower funding costs for lenders._" – _CMHC_
